  ...
  <div class="panel">
    <div class="panel-heading clearfix">
      <strong>
        ...
        <span>كل المأموريات</span>
     </strong>
     <div class="pull-right">
       <a href="sales.php" class="btn btn-primary">عرض كل المأموريات</a>
     </div>
    </div>
          ...
          <th> تعديل </th>
           ...
           <tbody  id="product_info">
              ...
              <form method="post" action="edit_sale.php?id=<?php echo (int)$sale['id']; ?>">
                ...
                <td>
                  <button type="submit" name="update_sale" class="btn btn-primary">تعديل مأمورية</button>
                </td>
              </form>
              </tr>
           </tbody>
