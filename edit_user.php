     ...
     <div class="panel panel-default">
       <div class="panel-heading">
        <strong>
          ...
          حساب <?php echo remove_junk(ucwords($e_user['name'])); ?> تعديل
        </strong>
       </div>
       <div class="panel-body">
          <form method="post" action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" class="clearfix">
            ...
            <div class="form-group clearfix">
                    <button type="submit" name="update" class="btn btn-info">تعديل</button>
            </div>
        </form>
       </div>
     </div>
  ...
  <div class="col-md-6">
    <div class="panel panel-default">
      <div class="panel-heading">
        <strong>
          <span class="glyphicon glyphicon-th"></span>
          كلمة السر <?php echo remove_junk(ucwords($e_user['name'])); ?> تغيير
        </strong>
      </div>
      <div class="panel-body">
        <form action="edit_user.php?id=<?php echo (int)$e_user['id'];?>" method="post" class="clearfix">
          ...
          <div class="form-group clearfix">
                  <button type="submit" name="update-pass" class="btn btn-danger pull-right">تغيير</button>
          </div>
        </form>
      </div>
    </div>
